...
abstract class AppLocalizations {
  ...
  /// No description provided for @fuelOrdering.
  ///
  /// In en, this message translates to:
  /// **'Fuel Ordering'**
  String get fuelOrdering;
...
AppLocalizations lookupAppLocalizations(Locale locale) {
  ...
  throw FlutterError(
    ...
    'reproducible sample app and the gen-l10n configuration that would reproduce this problem.'
  );
}
